...
/**
 * Created by t00037035 on 1/12/2017.
 */
...
public class DBAdapter {
    ...
    public static final String[] ALL_KEYS = new String[] {KEY_ROWID, KEY_FNAME, KEY_LNAME, KEY_EMAIL};
    ...
    public long insertRow(String fname, String lname, String email) {
        // [TO_DO_A8]
    ...
    public boolean updateRow(long rowId, String fname, String lname, String email) {
        String where = KEY_ROWID + "=" + rowId;
